...
# Query params
DerivMonthSchema = schemas.Int32Schema
PutOrCallSchema = schemas.StrSchema
StrikePriceSchema = schemas.Int32Schema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'DerivMonth': typing.Union[DerivMonthSchema, decimal.Decimal, int, ],
        'PutOrCall': typing.Union[PutOrCallSchema, str, ],
        'StrikePrice': typing.Union[StrikePriceSchema, decimal.Decimal, int, ],
    }
)
...
request_query_deriv_month = api_client.QueryParameter(
    name="DerivMonth",
    style=api_client.ParameterStyle.FORM,
    schema=DerivMonthSchema,
    required=True,
    explode=True,
)
request_query_put_or_call = api_client.QueryParameter(
    name="PutOrCall",
    style=api_client.ParameterStyle.FORM,
    schema=PutOrCallSchema,
    required=True,
    explode=True,
)
request_query_strike_price = api_client.QueryParameter(
    name="StrikePrice",
    style=api_client.ParameterStyle.FORM,
    schema=StrikePriceSchema,
    required=True,
    explode=True,
)
# Header params
...
SchemaFor200ResponseBodyApplicationJson = SymbolNameSuccess
...
class BaseApi(api_client.Api):
    @typing.overload
    def _symbolname_option_get_oapg(
        self,
    ...
    def _symbolname_option_get_oapg(
        ...
        for parameter in (
            request_query_deriv_month,
            request_query_put_or_call,
            request_query_strike_price,
        ):
...
class SymbolnameOptionGet(BaseApi):
    ...
    def symbolname_option_get(
        ...
        return self._symbolname_option_get_oapg(

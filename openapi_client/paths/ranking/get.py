...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'ExchangeDivision': typing.Union[ExchangeDivisionSchema, str, ],
    }
)
...
request_query_exchange_division = api_client.QueryParameter(
    name="ExchangeDivision",
    style=api_client.ParameterStyle.FORM,
    schema=ExchangeDivisionSchema,
    required=True,
    explode=True,
)
# Header params
...
class BaseApi(api_client.Api):
    ...
    def _ranking_get_oapg(
        ...
        for parameter in (
            request_query_type,
            request_query_exchange_division,
        ):

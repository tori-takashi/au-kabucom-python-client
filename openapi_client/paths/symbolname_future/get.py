...
# Query params
FutureCodeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'FutureCode': typing.Union[FutureCodeSchema, str, ],
    },
    total=False
)
...
request_query_future_code = api_client.QueryParameter(
    name="FutureCode",
    style=api_client.ParameterStyle.FORM,
    schema=FutureCodeSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _symbolname_future_get_oapg(
        self,
...
class SymbolnameFutureGet(BaseApi):
    ...
    def symbolname_future_get(
        ...
        return self._symbolname_future_get_oapg(

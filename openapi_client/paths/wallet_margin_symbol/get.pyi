...
SchemaFor200ResponseBodyApplicationJson = WalletMarginSuccess
...
class BaseApi(api_client.Api):
    @typing.overload
    def _wallet_margin_symbol_get_oapg(
        self,
...
class WalletMarginSymbolGet(BaseApi):
    ...
    def wallet_margin_symbol_get(
        ...
        return self._wallet_margin_symbol_get_oapg(

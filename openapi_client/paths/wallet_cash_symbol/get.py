...
SchemaFor200ResponseBodyApplicationJson = WalletCashSuccess
...
class BaseApi(api_client.Api):
    @typing.overload
    def _wallet_cash_symbol_get_oapg(
        self,
...
class WalletCashSymbolGet(BaseApi):
    ...
    def wallet_cash_symbol_get(
        ...
        return self._wallet_cash_symbol_get_oapg(

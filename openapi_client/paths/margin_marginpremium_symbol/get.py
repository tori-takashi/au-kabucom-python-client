...
SchemaFor200ResponseBodyApplicationJson = MarginPremiumResponse
...
class MarginpremiumGet(BaseApi):
    ...
    def marginpremium_get(
        ...
        return self._marginpremium_get_oapg(

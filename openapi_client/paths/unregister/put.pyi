...
# body param
SchemaForRequestBodyApplicationJson = RequestUnregister


request_body_request_unregister = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RegistSuccess
...
class BaseApi(api_client.Api):
    ...
    def _unregister_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_unregister.serialize(body, content_type)
...
class UnregisterPut(BaseApi):
    ...
    def unregister_put(
        ...
        return self._unregister_put_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = RequestSendOrder


request_body_request_send_order = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _sendorder_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_send_order.serialize(body, content_type)
...
class SendorderPost(BaseApi):
    ...
    def sendorder_post(
        ...
        return self._sendorder_post_oapg(
            body=body,

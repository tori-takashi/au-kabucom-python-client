...
request_path_symbol = api_client.PathParameter(
    name="symbol",
    style=api_client.ParameterStyle.SIMPLE,
    schema=SymbolSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = WalletOptionSuccess
...
class BaseApi(api_client.Api):
    @typing.overload
    def _wallet_option_symbol_get_oapg(
        self,
...
class WalletOptionSymbolGet(BaseApi):
    ...
    def wallet_option_symbol_get(
        ...
        return self._wallet_option_symbol_get_oapg(

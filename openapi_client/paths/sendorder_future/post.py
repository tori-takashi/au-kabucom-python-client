...
# body param
SchemaForRequestBodyApplicationJson = RequestSendOrderDerivFuture


request_body_request_send_order_deriv_future = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sendoder_future_post_oapg(
        self,
    ...
    def _sendoder_future_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_send_order_deriv_future.serialize(body, content_type)
...
class SendoderFuturePost(BaseApi):
    ...
    def sendoder_future_post(
        ...
        return self._sendoder_future_post_oapg(
            body=body,

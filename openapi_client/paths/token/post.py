...
# body param
SchemaForRequestBodyApplicationJson = RequestToken


request_body_request_token = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TokenSuccess
...
class BaseApi(api_client.Api):
    ...
    def _token_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_token.serialize(body, content_type)

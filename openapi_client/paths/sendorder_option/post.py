...
# body param
SchemaForRequestBodyApplicationJson = RequestSendOrderDerivOption


request_body_request_send_order_deriv_option = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OrderSuccess
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sendorder_option_post_oapg(
        self,
    ...
    def _sendorder_option_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_send_order_deriv_option.serialize(body, content_type)
...
class SendorderOptionPost(BaseApi):
    ...
    def sendorder_option_post(
        ...
        return self._sendorder_option_post_oapg(
            body=body,

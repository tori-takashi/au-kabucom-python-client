...
# body param
SchemaForRequestBodyApplicationJson = RequestCancelOrder


request_body_request_cancel_order = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _cancelorder_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_cancel_order.serialize(body, content_type)
...
class CancelorderPut(BaseApi):
    ...
    def cancelorder_put(
        ...
        return self._cancelorder_put_oapg(
            body=body,

...
SchemaFor200ResponseBodyApplicationJson = PrimaryExchangeResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _primary_exchange_get_oapg(
        self,
...
class PrimaryExchangeGet(BaseApi):
    ...
    def primary_exchange_get(
        ...
        return self._primary_exchange_get_oapg(

...
SchemaFor200ResponseBodyApplicationJson = WalletFutureSuccess
...
class BaseApi(api_client.Api):
    @typing.overload
    def _wallet_future_symbol_get_oapg(
        self,
...
class WalletFutureSymbolGet(BaseApi):
    ...
    def wallet_future_symbol_get(
        ...
        return self._wallet_future_symbol_get_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = RequestRegister


request_body_request_register = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _register_put_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_register.serialize(body, content_type)
...
class RegisterPut(BaseApi):
    ...
    def register_put(
        ...
        return self._register_put_oapg(
            body=body,

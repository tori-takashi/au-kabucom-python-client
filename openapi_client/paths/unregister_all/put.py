...
SchemaFor200ResponseBodyApplicationJson = UnregisterAllSuccess
...
class UnregisterAllPut(BaseApi):
    ...
    def unregister_all_put(
        ...
        return self._unregister_all_put_oapg(

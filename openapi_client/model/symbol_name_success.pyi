...
class SymbolNameSuccess(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Symbol", "SymbolName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Symbol", "SymbolName", ], str]):
